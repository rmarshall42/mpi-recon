...
PairNNP2v::PairNNP2v(LAMMPS *lmp) : Pair(lmp)
{
...
void PairNNP2v::compute(int eflag, int vflag)
{
...
void PairNNP2v::settings(int narg, char **/*arg*/)
{
...
void PairNNP2v::coeff(int narg, char **arg)
{
...
double PairNNP2v::init_one(int i, int j)
{
...
void PairNNP2v::read_file(char *file)
{
...
/* ---------------------------------------------------------------------- */
void PairNNP2v::sf_g2(int i, int j, double rij,
...
double PairNNP2v::fc(double rij)
{
...
double PairNNP2v::fc_deriv(double rij, double xi, double xj)
{
...
void PairNNP2v::sf_g5(int i, int j, int k, double rij, double rik,
                     double x1, double y1, double z1,
                     double x2, double y2, double z2,
...
/* ---------------------------------------------------------------------- */
void PairNNP2v::hdnnp_e_a(double *(&g2_a_a),  int num_g2_a_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP2v::hdnnp_f_a(double ***(&g2_deriv_a_a),  int num_g2_a_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP2v::hdnnp_e_b(double *(&g2_b_a),  int num_g2_b_a,
...
/* ---------------------------------------------------------------------- */
void PairNNP2v::hdnnp_f_b(double ***(&g2_deriv_b_a),  int num_g2_b_a,
